#imports
import cPickle, copy, difflib, gensim, jellyfish, matplotlib.pyplot as plt, matplotlib.cm as cm
    ...
    for b in a[2]:
        if not "ofra" in b:
            if store_pickle:
                #load necessary data
                print b
                pickle_file_name = b#'One_Direction.pkl'
                ...
                obj = get_pickle(pickle_file_name, folder = 'newer_predictions')
                if not obj.future_linked: 
                    ...
                    obj.future_linked = find_future_of_linked_paras(.8,5,.8,.4,4,13)

                    prediction_file = os.path.join(os.getcwd(), "newer_predictions", pickle_file_name)
